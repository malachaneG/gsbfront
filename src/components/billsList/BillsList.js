...
<td><button type="button" class="btn btn-info btn-sm"  onClick={this.handleShowModal}> <img src="edit.png" alt=""/></button>
                                    ...
                                    <tbody>
										{
                                            ...
                                            <td><input className="form-control form-control-sm" type="text" placeholder="libelle" name="libelle" value={this.state.rows[i].libelle} onChange={(e) => this.handleRowsChange(e, i)} /></td>
                                            <td><input type="text" placeholder ="Libelle" name="price" value={this.state.rows[i].price} onChange={(e) => this.handleRowsChange(e, i)}/></td>
